...
def test_gpm_mid_10_best17_a_uk_mapping_end_to_end(us_data_dir, uk_data_dir):
    ...
    # 2026-07-15 bugfix: kazda skladowa WLASNYM loaderem (nie na sztywno stooq_csv+data/us) - w
    # przeciwnym razie gpm_mid_10's `stooq_csv_dividend_adjusted` bylby CICHO ignorowany na
    # potrzeby TEGO porownania (patrz combined_pipeline.load_combined_daily_prices).
